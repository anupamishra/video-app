...
const Video = memo(function Video({ children, title, channel, views, time, verified, id, editVideo }) {
		...
		<>
			<div className='shadow rounded-xl text-white my-5 relative'>
				...
				<div className='bg-zinc-800 p-4 rounded-b-xl'>
					...
					<div className='views'>{views}M <span>-</span> {time}</div>
